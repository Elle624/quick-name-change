...
This simple application is built in couple of hours to practice React Context and React Hooks including useState, useEffect, and useRef. The next challenge is testing components with React testing library and jest, or a different testing library such as Cypress.
